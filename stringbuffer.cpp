...
NeubotStringBuffer::NeubotStringBuffer(NeubotPoller *p)
{
...
size_t
NeubotStringBuffer::get_length(void)
{
	return (evbuffer_get_length(this->buff));
}

int
NeubotStringBuffer::clear(void)
{
	if (evbuffer_unfreeze(this->buff, 0) != 0)
		return (-1);

	if (evbuffer_drain(this->buff, evbuffer_get_length(this->buff)) != 0)
		return (-1);
...
NeubotPoller *
NeubotStringBuffer::get_poller(void)
{
	return (this->poller);
}
